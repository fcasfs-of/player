...
if(video.title==""){   fplayeri.OnEvents("metadata",function(){    const mainVideddotime = document.getElementById('tvidlist_'+video.id);  if(mainVideddotime){  if(mainVideddotime.innerHTML=""){   mainVideddotime.innerHTML=""+fplayeri.api("playlist_title");  }  } videoTitle.innerHTML=""+fplayeri.api("playlist_title");  });   }
