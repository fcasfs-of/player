...
if (!run_file){
mainVideo.innerHTML='<div style="text-transform: uppercase;  overflow:auto; width:100%;text-align:center;color:#fff;background:#000;padding:5px;"><br/><br/><p>This File ID does not exist.</p><br/><br/><br/><br/><br/></div>';   }
